class CustomerService {
    ...
    async getCustomerById(db, customerId) {
        try {
    ...
    async createCustomer(db, customerData) {
        try {
        ...
        `)
                .bind(customerId, customerData.name, customerData.email || null, customerData.phone || null, customerData.address ? JSON.stringify(customerData.address) : null, customerData.dateOfBirth || null, customerData.gender || null)
                .run();
    ...
    async updateCustomer(db, customerId, updateData) {
        try {
            const updates = [];
            const values = [];
    ...
    async deleteCustomer(db, customerId) {
        try {
            await db
