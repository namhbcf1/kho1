...
import { VNPayPayment, MoMoPayment, ZaloPayPayment } from '../../../shared/schemas';
...
export class PaymentService {
  ...
  static verifyVNPayCallback(params: Record<string, string>, secretKey: string): boolean {
    try {
  ...
  static verifyMoMoCallback(params: Record<string, any>, secretKey: string): boolean {
    try {
      const {
        partnerCode,
        orderId,
  ...
  static verifyZaloPayCallback(params: Record<string, any>, key2: string): boolean {
    try {
