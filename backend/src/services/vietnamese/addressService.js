...
export class VietnameseAddressService {
     ...
     */
    static getAddressSuggestions(query, limit = 10) {
        const suggestions = [];
     ...
     */
    static getAddressHierarchy(address) {
        const result = {};
        if (address.provinceCode) {
     ...
     */
    static normalizeAddressText(text) {
        return text
            .toLowerCase()
            .normalize('NFD')
            .replace(/[\u0300-\u036f]/g, '')
