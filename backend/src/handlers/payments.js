...
export const paymentsHandlers = {
    ...
    async createVNPayPayment(request, env) {
        try {
    ...
    async handleVNPayCallback(request, env) {
        try {
    ...
    async createMoMoPayment(request, env) {
        try {
            const body = await request.json();
    ...
    async handleMoMoCallback(request, env) {
        try {
            const body = await request.json();
    ...
    async createZaloPayPayment(request, env) {
        try {
            const body = await request.json();
    ...
    async handleZaloPayCallback(request, env) {
        try {
            const body = await request.json();
