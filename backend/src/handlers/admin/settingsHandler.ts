...
export const settingsHandler = {
  ...
  async updateBusinessSettings(c: Context) {
    try {
      const db = c.env.DB;
  ...
  async updateTaxSettings(c: Context) {
    try {
      const db = c.env.DB;
  ...
  async updatePaymentSettings(c: Context) {
    try {
      const db = c.env.DB;
  ...
  async updateReceiptSettings(c: Context) {
    try {
      const db = c.env.DB;
  ...
  async updateLanguageSettings(c: Context) {
    try {
      const db = c.env.DB;
  ...
  async updateBackupSettings(c: Context) {
    try {
      const db = c.env.DB;
